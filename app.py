...
def index(m3u8):
    ...
    tsal = ts.text.replace(videoid+'_', f'https://erdoganladevam.herokuapp.com/getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/{videoid}_')
    if 'internal' in tsal:
        tsal = tsal.replace('internal', f'https://erdoganladevam.herokuapp.com/getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/internal')
    if 'segment' in tsal:
        tsal = tsal.replace('\nmedia', f'\nhttps://erdoganladevam.herokuapp.com/getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/media')
    return tsal
...
def getm3u8():
    ...
    ts = requests.get(source, headers=headers)
    tsal = ts.text
    tsal = tsal.replace(videoid+'_','https://erdoganladevam.herokuapp.com/getts&source=https://edge10.xmediaget.com/hls-live/'+videoid+'/1/'+videoid+'_')
    return tsal
