...
def index(m3u8):
    ...
    if "internal" in tsal:
        tsal = tsal.replace('internal', 'https://volestreamhd.global.ssl.fastly.net/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/internal')
