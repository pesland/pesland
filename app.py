...
def index(m3u8):
    ...
    tsal = ts.text.replace(videoid+'_', f'https://abinolurcalis.kkjfjfjsfjsfjsjfj.workers.dev/https://erdoganladevam.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/{videoid}_')
    if 'internal' in tsal:
        tsal = tsal.replace('internal', f'https://abinolurcalis.kkjfjfjsfjsfjsjfj.workers.dev/https://erdoganladevam.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/internal')
    if 'segment' in tsal:
        tsal = tsal.replace('\nmedia', f'\nhttps://abinolurcalis.kkjfjfjsfjsfjsjfj.workers.dev/https://erdoganladevam.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/media')
    return tsal
