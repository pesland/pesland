...
def index(m3u8):
    ...
    tsal = ts.text
    tsal = tsal.replace(videoid+'_','https://king-prawn-app-mx7i9.ondigitalocean.app/getstream?param=getts&source=https://edge11.xmediaget.com/hls-live/'+videoid+'/1/'+videoid+'_')
    if "internal" in tsal:
        tsal = tsal.replace('internal','https://king-prawn-app-mx7i9.ondigitalocean.app/getstream?param=getts&source=https://edge12.xmediaget.com/hls-live/'+videoid+'/1/internal')
    if "segment" in tsal:
        tsal = tsal.replace('\n'+'media','\n'+'https://king-prawn-app-mx7i9.ondigitalocean.app/getstream?param=getts&source=https://edge13.xmediaget.com/hls-live/'+videoid+'/1/media')
    return tsal
...
def getm3u8():
    ...
    ts = requests.get(source, headers=headers)
    tsal = ts.text
    tsal = tsal.replace(videoid+'_','https://king-prawn-app-mx7i9.ondigitalocean.app/getstream?param=getts&source=https://edge14.xmediaget.com/hls-live/'+videoid+'/1/'+videoid+'_')
    return tsal
