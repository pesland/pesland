...
def index(m3u8):
   ...
   ts = requests.get(source.format(videoid=videoid), headers=headers)
tsal = ts.text.replace(videoid+'_', f'https://cdn.ahgecelersensizeceler.workers.dev/getstream?param=getts&source={source.format(videoid=videoid)}_')
