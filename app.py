...
def index(m3u8):
   ...
   ts = requests.get(source, headers=headers)
    ...
    if 'segment' in tsal:
        tsal = tsal.replace('\nmedia', f'\nhttps://cdn.esraerol.workers.dev/https://plankton-app-ljeqg.ondigitalocean.app/https://volestream.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/media')
    return tsal
