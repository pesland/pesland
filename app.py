...
def index(m3u8):
    ...
    tsal = ts.text
    tsal = tsal.replace(videoid+'_','https://king-prawn-app-mx7i9.ondigitalocean.app/getstream?param=getts&source=https://edge9.xmediaget.com/hls-live/'+videoid+'/1/'+videoid+'_')
    if "internal" in tsal:
        tsal = tsal.replace('internal','https://king-prawn-app-mx7i9.ondigitalocean.app/getstream?param=getts&source=https://edge9.xmediaget.com/hls-live/'+videoid+'/1/internal')
    if "segment" in tsal:
        tsal = tsal.replace('\n'+'media','\n'+'https://king-prawn-app-mx7i9.ondigitalocean.app/getstream?param=getts&source=https://edge9.xmediaget.com/hls-live/'+videoid+'/1/media')
    return tsal
...
def getstream():
    ...
    if param == "getm3u8":
        ...
        if "FullscreenAllowed" in r.text:
            ...
            veri = veri.replace('edge3','edge9')
            veri = veri.replace('edge100','edge9')
            veri = veri.replace('edge4','edge9')
            veri = veri.replace('edge2','edge9')
            veri = veri.replace('edge5','edge9')
            veri = veri.replace('edge1','edge9')
            veri = veri.replace('edge6', 'edge9')
            veri = veri.replace('edge7', 'edge9')
