...
def index(m3u8):
    ...
    source = m3u8.replace('https://volestreamredirect1.ahgecelersensizeceler.workers.dev/', '')
    ...
    tsal = ts.text.replace(videoid+'_', f'https://volestreamredirect1.ahgecelersensizeceler.workers.dev/https://erdoganladevam.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/{videoid}_')
    if 'internal' in tsal:
        tsal = tsal.replace('internal', f'https://volestreamredirect1.ahgecelersensizeceler.workers.dev/https://erdoganladevam.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/internal')
    if 'segment' in tsal:
        tsal = tsal.replace('\nmedia', f'\nhttps://volestreamredirect1.ahgecelersensizeceler.workers.dev/https://erdoganladevam.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/media')
    return tsal
...
def getm3u8():
    ...
    ts = requests.get(source, headers=headers)
    tsal = ts.text
    tsal = tsal.replace(videoid+'_','https://volestreamredirect1.ahgecelersensizeceler.workers.dev/https://erdoganladevam.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/'+videoid+'/1/'+videoid+'_')
    return tsal
