...
def index(m3u8):
    ...
    tsal = tsal.replace(videoid + '_', 'https://proxys.yedekbirkankam.workers.dev/proxy/https://aa.megamacizle.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/' + videoid + '_')

    if "internal" in tsal:
        tsal = tsal.replace('internal', 'https://proxys.yedekbirkankam.workers.dev/proxy/https://aa.megamacizle.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/internal')

    if "segment" in tsal:
        tsal = tsal.replace('\n' + 'media',
                            '\n' + 'https://proxys.yedekbirkankam.workers.dev/proxy/https://aa.megamacizle.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/media')
