...
def index(m3u8):
    ...
    tsal = tsal.replace(videoid + '_', 'https://worker-holy-shadow-d82a.abinolurtelifatmanolur.workers.dev/https://seashell-app-cdk6o.ondigitalocean.app/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/' + videoid + '_')

    if "internal" in tsal:
        tsal = tsal.replace('internal', 'https://worker-holy-shadow-d82a.abinolurtelifatmanolur.workers.dev/https://seashell-app-cdk6o.ondigitalocean.app/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/internal')

    if "segment" in tsal:
        tsal = tsal.replace('\n' + 'media',
                            '\n' + 'https://worker-holy-shadow-d82a.abinolurtelifatmanolur.workers.dev/https://seashell-app-cdk6o.ondigitalocean.app/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/media')
