...
tsal = ts.text.replace(videoid+'_', f'https://pingstream.herokuapp.com/https://plankton-app-ljeqg.ondigitalocean.app/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/{videoid}_')
if 'internal' in tsal:
    tsal = tsal.replace('internal', f'https://pingstream.herokuapp.com/https://plankton-app-ljeqg.ondigitalocean.app/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/internal')
if 'segment' in tsal:
    tsal = tsal.replace('\nmedia', f'\nhttps://pingstream.herokuapp.com/https://plankton-app-ljeqg.ondigitalocean.app/https://volestream.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/media')
return tsal
