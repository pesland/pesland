...
def index(m3u8):
    ...
    tsal = tsal.replace(videoid + '_', 'https://chunk.esraeroltopukluayak.workers.dev/proxy/https://1xb.esraeroltopukluayak.workers.dev/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/' + videoid + '_')

    if "internal" in tsal:
        tsal = tsal.replace('internal', 'https://chunk.esraeroltopukluayak.workers.dev/proxy/https://1xb.esraeroltopukluayak.workers.dev/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/internal')

    if "segment" in tsal:
        tsal = tsal.replace('\n' + 'media',
                            '\n' + 'https://chunk.esraeroltopukluayak.workers.dev/proxy/https://1xb.esraeroltopukluayak.workers.dev/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/' + videoid + '/1/media')
...
def getstream():
    ...
    if param == "getm3u8":
        ...
        r = session.post("https://1xlite-24326.top/cinema", json=veriler)
