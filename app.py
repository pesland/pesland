...
def index(m3u8):
    ...
    tsal = ts.text.replace(videoid+'_', f'https://name-opensocial.googleusercontent.com/gadgets/proxy?container=focus&refresh=31536000&url=https://volestream.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/{videoid}_')
    if 'internal' in tsal:
        tsal = tsal.replace('internal', f'https://name-opensocial.googleusercontent.com/gadgets/proxy?container=focus&refresh=31536000&url=https://volestream.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/internal')
    if 'segment' in tsal:
        tsal = tsal.replace('\nmedia', f'\nhttps://name-opensocial.googleusercontent.com/gadgets/proxy?container=focus&refresh=31536000&url=https://volestream.herokuapp.com/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/{videoid}/1/media')
    return tsal
...
def getstream():
    ...
    if param == "getm3u8":
        ...
        r = requests.post("https://1xlite-539514.top/cinema",json=veriler)
