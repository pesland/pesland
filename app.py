...
def index(m3u8):
    ...
    if "internal" in tsal:
        tsal = tsal.replace('internal','https://lucky-bush-37ad.telifatmaoc.workers.dev/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/'+videoid+'/1/internal')
    if "segment" in tsal:
        tsal = tsal.replace('\n'+'media','\n'+'https://lucky-bush-37ad.telifatmaoc.workers.dev/getstream?param=getts&source=https://edge10.xmediaget.com/hls-live/'+videoid+'/1/media')
    return tsal
